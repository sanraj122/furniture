  ...
  <div class="col-50">
    <div class="container" >
      <form  action="payscript.php" method="post" style="padding: 25px;">
        ...
        <div class="row" >
          <div class="col-25">
            <h2 style="text-align: center;margin:20px 10px;font-family: sans-serif;">Payment Form</h2>
            ...
            <input type="text" id="city" name="mobile" placeholder="+91">
            <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
            <input type="text" id="adr" name="address" placeholder="Your current address">
